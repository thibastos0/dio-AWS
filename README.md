...
Foi utilizado o github/aws-samples para referência para criação do programa 'aws_textract_teste.py';
...
Criado o arquivo response.json e extraído as linhas com o texto detectado direto do .JSON, fins de limitar o acesso a AWS toda vez que o programa é testado.
